  ...
  <TextInput keyboardType="numeric" onChangeText={(e)=> setTva(e)} style={{backgroundColor:"white",borderWidth:1,borderColor:"green",width:"100%",height:45,paddingLeft:5}} placeholder="Tva"/>
     ...
     <View style={{backgroundColor:"#f13a11",width:Dimensions.get("window").width,marginTop:20,paddingBottom:20,borderTopRightRadius:15,borderTopLeftRadius:15}}>
       ...
       <View style={{margin:10}}>
         ...
         <TextInput onChangeText={(e)=>setSouplesse(e)} multiline={true} style={styles.input} style={{borderColor:'black',borderWidth:1,width:"100%",padding:10,backgroundColor:"white",borderRadius:10,marginTop:8}} placeholder='Souplesse test'/>

       </View>
       <View style={{margin:10}}>
         <Text style={{fontWeight:"bold",fontSize:16,color:"white"}}>Test des pompes:</Text>
         <TextInput onChangeText={(e)=>setPomps(e)} multiline={true} style={styles.input} style={{borderColor:'black',borderWidth:1,width:"100%",padding:10,backgroundColor:"white",borderRadius:10,marginTop:8}} placeholder='Pomps test'/>

       </View>
       <View style={{margin:10}}>
         <Text style={{fontWeight:"bold",fontSize:16,color:"white"}}>Test des abdos:</Text>
         <TextInput onChangeText={(e)=>setAbdos(e)} multiline={true} style={styles.input} style={{borderColor:'black',borderWidth:1,width:"100%",padding:10,backgroundColor:"white",borderRadius:10,marginTop:8}} placeholder='Abdos test'/>

       </View>
       <View style={{margin:10}}>
         <Text style={{fontWeight:"bold",fontSize:16,color:"white"}}>Test ruffier dickson:</Text>
         <TextInput onChangeText={(e)=>setRuffier(e)} multiline={true} style={styles.input} style={{borderColor:'black',borderWidth:1,width:"100%",padding:10,backgroundColor:"white",borderRadius:10,marginTop:8}} placeholder='Ruffier dickson test'/>
...
<View style={{width:Dimensions.get("window").width,justifyContent:"center",alignSelf:"center",alignItems:"center",marginTop:10}}>
     ...
     <View style={{backgroundColor:"#f13a11",width:Dimensions.get("window").width,marginTop:20,paddingBottom:20,borderTopRightRadius:15,borderTopLeftRadius:15}}>
       ...
       <View style={{margin:10}}>
       <Text style={{fontWeight:"bold",fontSize:16,color:"white"}}>La date:</Text>
         <TextInput onChangeText={(e)=>setFormDate(e)} multiline={true} style={styles.input} style={{borderColor:'black',borderWidth:1,width:"100%",padding:10,backgroundColor:"white",borderRadius:10,marginTop:8}} placeholder='La date'/>
         <Text style={{fontWeight:"bold",fontSize:16,color:"white"}}>Test formative:</Text>
         <TextInput onChangeText={(e)=>setForm(e)} multiline={true} style={styles.input} style={{borderColor:'black',borderWidth:1,width:"100%",padding:10,backgroundColor:"white",borderRadius:10,marginTop:8}} placeholder='Test formative'/>
     ...
     <View style={{flexDirection:"row",justifyContent:"space-around",alignItems:"center"}}>
     <TextInput onChangeText={(e)=>setNut2(e)} multiline={true} style={styles.input} style={{borderColor:'red',borderWidth:1,width:"70%",padding:10,marginBottom:10}} placeholder='Nutrition'/>
     ...
     <View style={{flexDirection:"row",justifyContent:"space-around",alignItems:"center"}}>
     <TextInput onChangeText={(e)=>setNut3(e)} multiline={true} style={styles.input} style={{borderColor:'red',borderWidth:1,width:"70%",padding:10,marginBottom:10}} placeholder='Nutrition'/>
     ...
     <View style={{flexDirection:"row",justifyContent:"space-around",alignItems:"center"}}>
     <TextInput onChangeText={(e)=>setNut4(e)} multiline={true} style={styles.input} style={{borderColor:'red',borderWidth:1,width:"70%",padding:10,marginBottom:10}} placeholder='Nutrition'/>
     ...
     <View style={{flexDirection:"row",justifyContent:"space-around",alignItems:"center"}}>
     <TextInput onChangeText={(e)=>setNut5(e)} multiline={true} style={styles.input} style={{borderColor:'red',borderWidth:1,width:"70%",padding:10,marginBottom:10}} placeholder='Nutrition'/>
     ...
     <View style={{flexDirection:"row",justifyContent:"space-around",alignItems:"center"}}>
     <TextInput onChangeText={(e)=>setNut6(e)} multiline={true} style={styles.input} style={{borderColor:'red',borderWidth:1,width:"70%",padding:10,marginBottom:10}} placeholder='Nutrition'/>
     ...
     <View style={{flexDirection:"row",justifyContent:"space-around",alignItems:"center"}}>
     <TextInput onChangeText={(e)=>setNut7(e)} multiline={true} style={styles.input} style={{borderColor:'red',borderWidth:1,width:"70%",padding:10,marginBottom:10}} placeholder='Nutrition'/>
